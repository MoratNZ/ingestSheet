...
class TestRowOperations(unittest.TestCase):
    def test_parseRow(self):
        ...
        self.assertDictEqual(result1, {
            ...
            'parent two': {'child one': 3, 'child two': 6, 'child three': 9},
            'parent three': {'child one': 11, 'child two': 14}, 'no parent': 17,
            'no children': 20}
        )
        ...
        self.assertDictEqual(result2, {
            ...
            'parent two': {'child one': 4, 'child two': 7, 'child three': None},
            'parent three': {'child one': 12, 'child two': 15}, 'no parent': 18, 'no children': 21}
        )
